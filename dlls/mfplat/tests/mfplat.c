...
static void test_compressed_media_types(IMFSourceResolver *resolver)
{
    ...
    {
        {
            ...
            L"video/mp4",
            {
                ...
                ATTR_UINT32(MF_MT_MPEG2_PROFILE, eAVEncH264VProfile_High),
                ATTR_UINT32(MF_MT_MPEG2_LEVEL, eAVEncH264VLevel2),
            },
        },
        {
            L"test-aac.mp4",
            L"video/mp4",
            {
                ...
                ATTR_UINT32(MF_MT_AUDIO_AVG_BYTES_PER_SECOND, 9180, .todo = TRUE),
        ...
        },
        {
            ...
            L"video/mp4",
            {
                ...
                ATTR_GUID(MF_MT_AM_FORMAT_TYPE, FORMAT_WaveFormatEx),
                ATTR_UINT32(MF_MT_AUDIO_NUM_CHANNELS, 1),
                ATTR_UINT32(MF_MT_AUDIO_SAMPLES_PER_SECOND, 44100, .todo = TRUE),
                ATTR_UINT32(MF_MT_AUDIO_PREFER_WAVEFORMATEX, 1),
                ATTR_UINT32(MF_MT_FIXED_SIZE_SAMPLES, 1),
                ATTR_UINT32(MF_MT_ALL_SAMPLES_INDEPENDENT, 1),
            },
    ...
    for (unsigned int i = 0; i < ARRAY_SIZE(tests); ++i)
    {
        ...
        ok(hr == S_OK, "Got hr %#lx.\n", hr);
        todo_wine_if (i == 5) ok(count == 1, "Got type count %lu.\n", count);
