...
WIDL_impl_outer_IWineForceFeedbackEffectImpl( effect, effect_impl,
    IForceFeedbackEffect, effect,
    IAgileObject, effect_agile,
    END, FIXME
);
...
WIDL_impl_IWineForceFeedbackEffectImplVtbl( effect, effect_impl );
...
WIDL_impl_IForceFeedbackEffectVtbl( effect, effect );
WIDL_impl_IAgileObjectVtbl( effect, effect_agile );
...
HRESULT force_feedback_effect_create( enum WineForceFeedbackEffectType type, IInspectable *outer, IWineForceFeedbackEffectImpl **out )
{
    ...
    impl->IAgileObject_iface.lpVtbl = &effect_agile_vtbl;
    impl->outer = outer;
    impl->refcount = 1;
...
WIDL_impl_IForceFeedbackMotor( motor, motor,
    IAgileObject, motor_agile,
    END, FIXME
);
...
WIDL_impl_IForceFeedbackMotorVtbl( motor, motor );
WIDL_impl_IAgileObjectVtbl( motor, motor_agile );
...
HRESULT force_feedback_motor_create( IDirectInputDevice8W *device, IForceFeedbackMotor **out )
{
    ...
    impl->IAgileObject_iface.lpVtbl = &motor_agile_vtbl;
