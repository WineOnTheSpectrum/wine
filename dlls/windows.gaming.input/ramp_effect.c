...
WIDL_impl_IUnknown_AddRef( ramp_effect, IRampForceEffect, effect );
WIDL_impl_IUnknown_Release( ramp_effect, IRampForceEffect, effect );
WIDL_impl_IInspectable_methods( ramp_effect, IRampForceEffect, effect );
...
WIDL_impl_IRampForceEffectVtbl( ramp_effect, effect );
...
WIDL_impl_static_IActivationFactory( ramp_factory, activation,
    IAgileObject, ramp_factory_agile,
    END, FIXME
);
...
WIDL_impl_IActivationFactoryVtbl( ramp_factory, activation );
WIDL_impl_IAgileObjectVtbl( ramp_factory, ramp_factory_agile );

static struct ramp_factory ramp_statics =
{
    {&activation_vtbl},
    {&ramp_factory_agile_vtbl},
