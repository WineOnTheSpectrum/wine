...
WIDL_impl_IUnknown_AddRef( periodic_effect, IPeriodicForceEffect, effect );
WIDL_impl_IUnknown_Release( periodic_effect, IPeriodicForceEffect, effect );
WIDL_impl_IInspectable_methods( periodic_effect, IPeriodicForceEffect, effect );
...
WIDL_impl_IPeriodicForceEffectVtbl( periodic_effect, effect );
...
WIDL_impl_static_IActivationFactory( periodic_factory, activation,
    IPeriodicForceEffectFactory, factory,
    IAgileObject, periodic_factory_agile,
    END, FIXME
);
...
WIDL_impl_IActivationFactoryVtbl( periodic_factory, activation );
...
WIDL_impl_IPeriodicForceEffectFactoryVtbl( periodic_factory, factory );
WIDL_impl_IAgileObjectVtbl( periodic_factory, periodic_factory_agile );

static struct periodic_factory periodic_statics =
{
    {&activation_vtbl},
    {&factory_vtbl},
    {&periodic_factory_agile_vtbl},
