...
WIDL_impl_IUnknown_AddRef( constant_effect, IConstantForceEffect, effect );
WIDL_impl_IUnknown_Release( constant_effect, IConstantForceEffect, effect );
WIDL_impl_IInspectable_methods( constant_effect, IConstantForceEffect, effect );
...
WIDL_impl_IConstantForceEffectVtbl( constant_effect, effect );
...
WIDL_impl_static_IActivationFactory( constant_factory, activation,
    IAgileObject, constant_factory_agile,
    END, FIXME
);
...
WIDL_impl_IActivationFactoryVtbl( constant_factory, activation );
WIDL_impl_IAgileObjectVtbl( constant_factory, constant_factory_agile );

static struct constant_factory constant_statics =
{
    {&activation_vtbl},
    {&constant_factory_agile_vtbl},
