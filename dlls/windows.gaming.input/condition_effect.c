...
WIDL_impl_IUnknown_AddRef( condition_effect, IConditionForceEffect, effect );
WIDL_impl_IUnknown_Release( condition_effect, IConditionForceEffect, effect );
WIDL_impl_IInspectable_methods( condition_effect, IConditionForceEffect, effect );
...
WIDL_impl_IConditionForceEffectVtbl( condition_effect, effect );
...
WIDL_impl_static_IActivationFactory( condition_factory, activation,
    IConditionForceEffectFactory, factory,
    IAgileObject, condition_factory_agile,
    END, FIXME
);
...
WIDL_impl_IActivationFactoryVtbl( condition_factory, activation );
...
WIDL_impl_IConditionForceEffectFactoryVtbl( condition_factory, factory );
WIDL_impl_IAgileObjectVtbl( condition_factory, condition_factory_agile );

static struct condition_factory condition_statics =
{
    {&activation_vtbl},
    {&factory_vtbl},
    {&condition_factory_agile_vtbl},
