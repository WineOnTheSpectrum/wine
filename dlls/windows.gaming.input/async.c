...
WIDL_impl_outer_IWineAsyncInfoImpl( async_info, async_impl,
    IAgileObject, async_info_agile,
...
WIDL_impl_IWineAsyncInfoImplVtbl( async_info, async_impl );
...
WIDL_impl_IAgileObjectVtbl( async_info, async_info_agile );
WIDL_impl_IAsyncInfoVtbl( async_info, async_info );
                                  ...
                                  IInspectable *outer, IWineAsyncInfoImpl **out )
{
    ...
    impl->IAgileObject_iface.lpVtbl = &async_info_agile_vtbl;
    impl->outer = outer;
    impl->refcount = 1;
...
WIDL_impl_IUnknown_AddRef( async_bool, IAsyncOperation_boolean, async_bool );
WIDL_impl_IUnknown_Release( async_bool, IAsyncOperation_boolean, async_bool );
WIDL_impl_IInspectable_methods( async_bool, IAsyncOperation_boolean, async_bool );
...
WIDL_impl_IAsyncOperation_booleanVtbl( async_bool, async_bool );
...
WIDL_impl_IUnknown_AddRef( async_result, IAsyncOperation_ForceFeedbackLoadEffectResult, async_result );
WIDL_impl_IUnknown_Release( async_result, IAsyncOperation_ForceFeedbackLoadEffectResult, async_result );
WIDL_impl_IInspectable_methods( async_result, IAsyncOperation_ForceFeedbackLoadEffectResult, async_result );
...
WIDL_impl_IAsyncOperation_ForceFeedbackLoadEffectResultVtbl( async_result, async_result );
