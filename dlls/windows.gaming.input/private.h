...
#define DEFINE_IINSPECTABLE_( pfx, iface_type, impl_type, impl_from, expr )                         \
    ...
    WIDL_impl_IUnknown_forwards_( impl_type, iface_type, IInspectable, expr, pfx, impl_from )       \
    WIDL_impl_IInspectable_forwards_( impl_type, iface_type, IInspectable, expr, pfx, impl_from )
...
#define DEFINE_IAGILEOBJECT( type, base, expr )                                                     \
    ...
    WIDL_impl_IUnknown_forwards_( type, IAgileObject, base, expr, type ## _agile, type ## _from_IAgileObject ) \
