...
WIDL_impl_outer_IGameControllerImpl( racing_wheel, controller,
    IGameControllerInputSink, input_sink,
...
WIDL_impl_IGameControllerImplVtbl( racing_wheel, controller );
...
WIDL_impl_IGameControllerInputSinkVtbl( racing_wheel, input_sink );
...
WIDL_impl_IRacingWheelVtbl( racing_wheel, racing_wheel );
...
WIDL_impl_static_IActivationFactory( racing_wheel_statics, factory,
    IRacingWheelStatics, statics,
    IRacingWheelStatics2, statics2,
    ICustomGameControllerFactory, controller_factory,
    IAgileObject, racing_wheel_statics_agile,
    END, FIXME
);
...
WIDL_impl_IActivationFactoryVtbl( racing_wheel_statics, factory );
...
WIDL_impl_IRacingWheelStaticsVtbl( racing_wheel_statics, statics );
...
WIDL_impl_IRacingWheelStatics2Vtbl( racing_wheel_statics, statics2 );
...
WIDL_impl_ICustomGameControllerFactoryVtbl( racing_wheel_statics, controller_factory );
WIDL_impl_IAgileObjectVtbl( racing_wheel_statics, racing_wheel_statics_agile );
...
static struct racing_wheel_statics racing_wheel_statics =
{
    ...
    {&racing_wheel_statics_agile_vtbl},
